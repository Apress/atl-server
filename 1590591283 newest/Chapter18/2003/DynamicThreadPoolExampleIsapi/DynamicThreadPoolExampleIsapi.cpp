// DynamicThreadPoolExampleIsapi.cpp : Defines the entry point for the DLL application.
//

#include "stdafx.h"
#include "dynamicthreadpool.h"

[ module(name="MyDynamicThreadPoolExample", type="dll") ];
[ emitidl(restricted) ];

typedef CIsapiExtension< CDynamicThreadPool<> > ExtensionType;
