// sessionstateIsapi.cpp : Defines the entry point for the DLL application.
//
...
#endif
[ module(name="Mysessionstate", type="dll") ];
[ emitidl(restricted) ];

#include "sessionstateextension.h"

typedef CsessionstateExtension<> ExtensionType;
