========================================================================
       ATL SERVER : DataAccessIsapi Project Overview
========================================================================

AppWizard has created this DataAccessIsapi application for you.  This application
...
make up your DataAccessIsapi application.

DataAccessIsapi.vcproj
...
DataAccessextension.h
    This file contains your CIsapiExtension derived ISAPI Extension class:
    CDataAccessExtension that is customized based on the options you chose 
    in the AppWizard.
