// DataAccessIsapi.cpp : Defines the entry point for the DLL application.
//
...
#endif
[ module(name="MyDataAccess", type="dll") ];
[ emitidl(restricted) ];

#include "DataAccessextension.h"

typedef CDataAccessExtension<CThreadPool<CDataAccessExtensionWorker> > ExtensionType;
