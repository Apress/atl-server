...
// CWebJukeboxExtensionWorker - custom thread worker class
// for per-thread services

class CWebJukeboxExtensionWorker : public CIsapiWorker
{
...
}; // class CWebJukeboxExtensionWorker

// CWebJukeboxExtension - the ISAPI extension class
template <class ThreadPoolClass=CThreadPool<CWebJukeboxExtensionWorker>, 
