...
#ifndef __IPPMInternal_FWD_DEFINED__
#define __IPPMInternal_FWD_DEFINED__
typedef interface IPPMInternal IPPMInternal;
#endif 	/* __IPPMInternal_FWD_DEFINED__ */
...
#define	ENC_MAX_SIZE	( 4091 )

#define	DEC_MAX_SIZE	( 10954 )
...
EXTERN_C const IID IID_IPassportTicket2;
    ...
    public:
        ...
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE ConsentStatus( 
            /* [in] */ VARIANT_BOOL RequireConsentCookie,
...
#define IPassportTicket2_ConsentStatus(This,RequireConsentCookie,consentFlags,pConsentCode)	\
    (This)->lpVtbl -> ConsentStatus(This,RequireConsentCookie,consentFlags,pConsentCode)
...
#ifndef __IPPMInternal_INTERFACE_DEFINED__
#define __IPPMInternal_INTERFACE_DEFINED__

/* interface IPPMInternal */
/* [unique][helpstring][hidden][dual][uuid][object] */ 


EXTERN_C const IID IID_IPPMInternal;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("3936f927-3238-478b-a68b-083798d8b07a")
    IPPMInternal : public IUnknown
    {
    public:
        virtual /* [helpstring][hidden][id] */ HRESULT STDMETHODCALLTYPE P_GetDomainAttribute( 
            /* [in] */ LPCWSTR attributeName,
            /* [in] */ USHORT lcid,
            /* [in] */ LPCWSTR domain,
            /* [out] */ UINT *pBufSize,
            /* [out] */ LPWSTR *pBuffer) = 0;
        
        virtual /* [helpstring][hidden][id] */ HRESULT STDMETHODCALLTYPE P_DomainExists( 
            /* [in] */ LPCWSTR domainName,
            /* [out] */ VARIANT_BOOL *pbExists) = 0;
        
    };
    
#else 	/* C style interface */

    typedef struct IPPMInternalVtbl
    {
        BEGIN_INTERFACE
        ...
        /* [helpstring][hidden][id] */ HRESULT ( STDMETHODCALLTYPE *P_GetDomainAttribute )( 
            IPPMInternal * This,
            /* [in] */ LPCWSTR attributeName,
            /* [in] */ USHORT lcid,
            /* [in] */ LPCWSTR domain,
        ...
        /* [helpstring][hidden][id] */ HRESULT ( STDMETHODCALLTYPE *P_DomainExists )( 
            IPPMInternal * This,
            /* [in] */ LPCWSTR domainName,
            /* [out] */ VARIANT_BOOL *pbExists);
    ...
    interface IPPMInternal
    {
        CONST_VTBL struct IPPMInternalVtbl *lpVtbl;
    };
...
#define IPPMInternal_QueryInterface(This,riid,ppvObject)	\
    (This)->lpVtbl -> QueryInterface(This,riid,ppvObject)

#define IPPMInternal_AddRef(This)	\
    (This)->lpVtbl -> AddRef(This)

#define IPPMInternal_Release(This)	\
    (This)->lpVtbl -> Release(This)


#define IPPMInternal_P_GetDomainAttribute(This,attributeName,lcid,domain,pBufSize,pBuffer)	\
    (This)->lpVtbl -> P_GetDomainAttribute(This,attributeName,lcid,domain,pBufSize,pBuffer)

#define IPPMInternal_P_DomainExists(This,domainName,pbExists)	\
    (This)->lpVtbl -> P_DomainExists(This,domainName,pbExists)
...
/* [helpstring][hidden][id] */ HRESULT STDMETHODCALLTYPE IPPMInternal_P_GetDomainAttribute_Proxy( 
    IPPMInternal * This,
    /* [in] */ LPCWSTR attributeName,
    /* [in] */ USHORT lcid,
    /* [in] */ LPCWSTR domain,
...
void __RPC_STUB IPPMInternal_P_GetDomainAttribute_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][hidden][id] */ HRESULT STDMETHODCALLTYPE IPPMInternal_P_DomainExists_Proxy( 
    IPPMInternal * This,
    /* [in] */ LPCWSTR domainName,
    /* [out] */ VARIANT_BOOL *pbExists);


void __RPC_STUB IPPMInternal_P_DomainExists_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
#endif 	/* __IPPMInternal_INTERFACE_DEFINED__ */
