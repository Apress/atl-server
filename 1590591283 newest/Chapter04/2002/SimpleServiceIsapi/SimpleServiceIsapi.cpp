// SimpleServiceIsapi.cpp : Defines the entry point for the DLL application.
//

#include "stdafx.h"
#include "SimpleCounter.h"
#include "CMyIsapiExtension.h"
// For custom assert and trace handling with WebDbg.exe
#ifdef _DEBUG
CDebugReportHook g_ReportHook;
#endif
[ module(name="MySimpleService", type="dll") ];
[ emitidl(restricted) ];

typedef CMyIsapiExtension<> ExtensionType;
